...
#[tauri::command]
pub fn local_detect(component: String) -> Result<ProxyStatus, String> {
...
#[tauri::command]
pub fn local_enable(component: String, config: ProxyConfig) -> Result<OpResult, String> {
    match component.as_str() {
...
#[tauri::command]
pub fn local_disable(component: String) -> Result<OpResult, String> {
    match component.as_str() {
