...
export function Sidebar({
  ...
  return (
    <aside className="flex h-full min-h-0 flex-col bg-white px-3 py-3.5">
      <div className="mb-4 flex items-center gap-2.5 px-1">
        <img
          src={appIcon}
          alt=""
          className="h-8 w-8 rounded-[9px] shadow-[0_1px_2px_rgba(10,21,45,0.18)]"
        />
        <div className="min-w-0">
          <div className="font-display text-[15px] font-semibold tracking-tight text-[#0a1b33]">
            Proxy Switch
          </div>
      ...
      <div className="px-1 font-display text-[11px] font-semibold text-[#0a1b33]">
        Servers
      </div>
      ...
      <div className="mt-2 flex min-h-0 flex-1 flex-col gap-2 overflow-y-auto pr-0.5">
        ...
        {servers.length === 0 && (
          <div className="rounded-[12px] bg-[#f9fafb] px-3 py-6 text-center text-[12px] text-[#64748b]">
            No servers yet
          </div>
        )}
      </div>
      ...
      <div className="mt-4 px-1 font-display text-[11px] font-semibold text-[#0a1b33]">
        Local
      </div>
      <div className="mt-2 rounded-[12px] bg-[#f9fafb] px-3 py-2.5">
